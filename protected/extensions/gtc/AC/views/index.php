<h1>Application Component Generator</h1>
<p>This generator helps you to quickly generate a new class for application components.</p>
...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    <div class="row">
        ...
        <div class="tooltip">
            Component class name must only contain word characters.
        </div>
	...
	<div class="row sticky">
		...
		<div class="tooltip">
			This is the class that the new component class will extend from.

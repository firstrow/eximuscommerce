<?php
class ACCode extends CCodeModel
{
    public $className;
    public $baseClass='CApplicationComponent';
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), array(
            ...
            'className'=>'Class Name of the Application Component',
	...
	{
		$output=<<<EOD
<p>The application component has been generated successfully.</p>
EOD;

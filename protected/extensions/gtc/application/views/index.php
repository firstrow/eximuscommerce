...
<p>This generator helps you to quickly generate a new application class.</p>
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    <div class="row">
        <?php echo $form->labelEx($model,'className'); ?>
        <?php echo $form->textField($model,'className',array('size'=>65)); ?>
        <div class="tooltip">
            Application class name must only contain word characters.
        </div>
	...
	<div class="row sticky">
		...
		<div class="tooltip">
			This is the class that the new application class will extend from.
		</div>

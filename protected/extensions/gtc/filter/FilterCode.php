<?php
class FilterCode extends CCodeModel
{
    public $className;
    public $baseClass='CFilter';
    public $scriptPath='ext.web.filters';
    ...
    {
        $path=Yii::getPathOfAlias($this->scriptPath).'/' . ucfirst($this->className) . 'Filter.php';
